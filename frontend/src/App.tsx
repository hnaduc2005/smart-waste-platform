...
function App() {
  return (
    <div className="min-h-screen font-sans bg-slate-900 text-slate-100 flex flex-col relative overflow-hidden">
      {/* Component Tự Động Bắn Popup Thông Báo (Giai Đoạn 4) */}
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto py-10 px-4 sm:px-6 relative z-10 flex flex-col items-center justify-center min-h-[90vh] gap-12">
        <WasteClassifierPage />
        
        {/* Phân tách giữa Giai đoạn 5 (AI) và Giai đoạn 4 (Gamification) */}
        <div className="w-full h-px bg-gradient-to-r from-transparent via-slate-600 to-transparent my-8"></div>
        
        {/* Giai đoạn 4 - Hiển thị Gamification */}
        <GamificationPage />
      </main>
